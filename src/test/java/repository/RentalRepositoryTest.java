...
class RentalRepositoryTest {
    ...
    void testSaveAndFindAll() {
        ...
        Vehicle vehicle =
                new Vehicle(1, "Toyota", "Corolla", 50.0,
    ...
    void testFindActiveRentalByVehicleId_ReturnRental() {
        ...
        Vehicle vehicle =
                new Vehicle(10, "Toyota", "Corolla", 50.0,
        ...
        Rental result =
                rentalRepository.findActiveRentalByVehicleId(10);
    ...
    void testFindActiveRentalByVehicleId_ReturnNull() {
        ...
        Rental result =
                rentalRepository.findActiveRentalByVehicleId(999);
    ...
    void testFindActiveRentalByVehicleId_WhenRentalClosed() {
        ...
        Vehicle vehicle =
                new Vehicle(5, "Toyota", "Corolla", 50.0,
                        VehicleStatus.RENTED);
        ...
        Rental result =
                rentalRepository.findActiveRentalByVehicleId(5);
